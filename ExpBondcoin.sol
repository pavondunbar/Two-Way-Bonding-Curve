...
contract BondCoin is ERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public constant BASE_RATE = 1010000000000000000; // 1.01 in 18 decimals
    ...
    function getCurrentPrice() public view returns (uint256) {
        ...
        // Price = INITIAL_PRICE * (BASE_RATE ^ supply)
        uint256 supply = totalSupply();
        uint256 price = INITIAL_PRICE;

        for (uint256 i = 0; i < supply / PRECISION; i++) {
            price = (price * BASE_RATE) / PRECISION;
        }
